...
2. **For each task**, the orchestrator selects the least expensive model capable of performing the task, many tasks will not need high reasoning models. Then launch a new agent with:
   - The task file path
